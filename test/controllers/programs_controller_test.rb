...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference('Program.count') do
      post programs_url, params: { program: { code: @program.code, name: @program.name, status: @program.status } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { code: @program.code, name: @program.name, status: @program.status } }
