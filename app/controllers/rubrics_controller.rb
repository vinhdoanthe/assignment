class RubricsController < ApplicationController
  ...
  def new
    ...
    @course_instances = CourseInstance.where(status: 'active')

    if params[:assignment_id].present?
      @rubric.assignment_id = params[:assignment_id]
      @assignments = Assignment.where(course_instance_id: @rubric.assignment.course_instance_id)
    else
      @assignments = []
    end
  end
