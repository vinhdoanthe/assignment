class SubmissionGradesController < ApplicationController
  ...
  private
    ...
    def submission_grade_params
      params.require(:submission_grade).permit(:assignment_id, :student_id, :submission_status, :submission_file_id, :attempt_count, :latest, :mentor_id, :grade_status, :graded_rubric_id, :graded_file_id, :point)
    end
end
